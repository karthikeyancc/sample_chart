...
const DatetimeButton = class {
  constructor(hostRef) {
    ...
    this.waitForDatetimeChanges = /*#__PURE__*/(0,E_DigitalByDesign_code_poc_sample_chart_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,E_DigitalByDesign_code_poc_sample_chart_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
